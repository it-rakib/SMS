...
var TaskSummaryManager = {
    gridDataSource: function (ticketId, AssigneeUserId) {
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/Task/GetAllTicketTaskMData",
                    type: "POST",
                    dataType: "json",
                    cache: false,
                    data: { ticketId: ticketId, AssigneeUserId: AssigneeUserId }
                },
...
var TaskSummaryHelper = {
    ...
    GenerateTaskGrid: function () {
        ...
        $("#kTaskGrid").kendoGrid({
            dataSource: TaskSummaryManager.gridDataSource(ticketId, AssigneeUserId),
            pageable: {
                refresh: true,
                serverPaging: true,
                serverFiltering: true,
    ...
    GenerateEnternalNotesGrid: function () {
        ...
        $("#kENotesGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "t_TaskId", title: "T_TaskId", width: 150, hidden: true
                },
                {
    ...
    GenerateTimeGrid: function () {
        ...
        $("#kTimeGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "startedBy", title: "Started By", hidden: true, sortable: true, width: 120
                },
                {
